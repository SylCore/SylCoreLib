...
--- Eluna BattleGround Event IDs
---@class BGEvents
---@field BG_EVENT_ON_START       integer 
---@field BG_EVENT_ON_END         integer
---@field BG_EVENT_ON_CREATE      integer 
---@field BG_EVENT_ON_PRE_DESTROY integer 

---@class ElunaNamespace
---@field BGEvents BGEvents
