...
--- Eluna Spell Event IDs
---@class SpellEvents
---@field SPELL_EVENT_ON_PREPARE     integer
---@field SPELL_EVENT_ON_CAST        integer
---@field SPELL_EVENT_ON_CAST_CANCEL integer

---@class ElunaNamespace
---@field SpellEvents SpellEvents
