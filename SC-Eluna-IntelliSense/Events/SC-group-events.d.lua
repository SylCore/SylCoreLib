...
--- Eluna Group Event IDs
---@class GroupEvents
---@field GROUP_EVENT_ON_MEMBER_ADD    integer
---@field GROUP_EVENT_ON_MEMBER_INVITE integer
---@field GROUP_EVENT_ON_MEMBER_REMOVE integer
---@field GROUP_EVENT_ON_LEADER_CHANGE integer
---@field GROUP_EVENT_ON_DISBAND       integer
---@field GROUP_EVENT_ON_CREATE        integer

---@class ElunaNamespace
---@field GroupEvents GroupEvents
