...
--- Eluna Ticket Event IDs
---@class TicketEvents
---@field TICKET_EVENT_ON_CREATE     integer
---@field TICKET_EVENT_UPDATE_LAST_CHANGE     integer
---@field TICKET_EVENT_ON_CLOSE      integer
---@field TICKET_EVENT_ON_RESOLVE integer

---@class ElunaNamespace
---@field TicketEvents TicketEvents
