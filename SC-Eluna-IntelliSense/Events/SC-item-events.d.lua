...
--- Eluna Item Event IDs
---@class ItemEvents
---@field ITEM_EVENT_ON_DUMMY_EFFECT integer
---@field ITEM_EVENT_ON_USE          integer
---@field ITEM_EVENT_ON_QUEST_ACCEPT integer
---@field ITEM_EVENT_ON_EXPIRE       integer
---@field ITEM_EVENT_ON_REMOVE       integer

---@class ElunaNamespace
---@field ItemEvents ItemEvents
