...
--- Eluna Packet Event IDs
---@class PacketEvents
---@field PACKET_EVENT_ON_PACKET_RECEIVE         integer
---@field PACKET_EVENT_ON_PACKET_RECEIVE_UNKNOWN integer
---@field PACKET_EVENT_ON_PACKET_SEND            integer

---@class ElunaNamespace
---@field PacketEvents PacketEvents
