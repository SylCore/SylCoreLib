...
--- Eluna Guild Event IDs
---@class GuildEvents
---@field GUILD_EVENT_ON_ADD_MEMBER      integer
---@field GUILD_EVENT_ON_REMOVE_MEMBER   integer
---@field GUILD_EVENT_ON_MOTD_CHANGE     integer
---@field GUILD_EVENT_ON_INFO_CHANGE     integer
---@field GUILD_EVENT_ON_CREATE          integer
---@field GUILD_EVENT_ON_DISBAND         integer
---@field GUILD_EVENT_ON_MONEY_WITHDRAW  integer
---@field GUILD_EVENT_ON_MONEY_DEPOSIT   integer
---@field GUILD_EVENT_ON_ITEM_MOVE       integer
---@field GUILD_EVENT_ON_EVENT           integer
---@field GUILD_EVENT_ON_BANK_EVENT      integer


---@class ElunaNamespace
---@field GuildEvents GuildEvents
